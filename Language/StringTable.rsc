StringTable resource
{
	...
	[
		...
		{ String _name = "PackedDirtRoadTip";			String _text = "Twice as long to build, twice as fast."; }

		{ String _name = "PavedStoneRoad";			String _text = "Paved Stone Road"; }
		{ String _name = "PavedStoneRoadLwr";			String _text = "paved stone road"; }
		{ String _name = "PavedStoneRoadTip";			String _text = "Twice as long to build, twice the resources, four times as fast."; }
		...
		{ String _name = "QuarriedStone";			String _text = "Quarried Stone"; }
	]
}
