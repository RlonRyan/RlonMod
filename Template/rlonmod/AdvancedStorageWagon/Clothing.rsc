...
ToolbarDescription toolbar
{
	...
	String _spriteName = "LeatherCoat";

	StringTable _stringTable = "Language/rlonmod/AdvancedStorageStringTable.rsc:wagon";
	String _stringName = "Clothing";
	String _stringNameLwr = "ClothingLwr";
	String _toolTip = "ClothingTip";
...
{
	RawMaterialFlags _storageFlags = Clothing;	
